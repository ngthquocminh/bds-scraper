...
def main():
    ...
    channel.queue_declare(queue='worker3')
    ...
    channel.basic_consume(queue='worker3', on_message_callback=callback, auto_ack=True)
...
def start_crawling(param):
    ...
    crawler.obtainData("post_urls_3")



def start_parsing(param):
    status_parse = param[0]
    parser = BatDongSanParser("post_urls_3", "data_parsed3")
